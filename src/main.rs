...
use controller::{add_friend_handler, change_flag_handler, code_handler, create_matched_handler, get_accepted_boys_handler, get_all_users_handler, get_boys_handler, get_girl_request_handler, get_girls_handler, get_matched_handler, get_user_byId_handler, get_user_handler, login_handler, reject_handler, signup_handler, update_contest_score_handler, update_score_handler, update_user_character_handler};
